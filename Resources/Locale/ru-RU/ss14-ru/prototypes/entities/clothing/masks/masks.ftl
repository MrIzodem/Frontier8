...
ent-ClothingMaskGasDustRaider = респиратор рейдера Dust Troopers
  .desc = Стальная маска с линзами под ней и плотная вуаль поверх респиратора... Покойся с миром, старый друг...