...
ent-ClothingUniformJumpsuitST = комбинезон Scrap Tech
    .desc = Старый и грязный прорезиненный оранжевый комбинезон с системой ремней, карманов, и сбруй для ношения разного рода снаряжения. Обычно, его носят утилизаторы, механики, шахтеры, и прочие "чернорабочие" ST.
