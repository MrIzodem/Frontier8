...
ent-PosterSTsun = Солнце 91-го сектора
    .desc = Под футуристичным солнцем и закатным небом выведена надпись-«Солнце Соларма никогда не заходит», по какой-то причине рядом имеется логотип Scrap Tech.
ent-PosterSTRay = «Liwer» значит «Live»
    .desc = Рекламный плакат LF с изображением их маскота-антропоморфного солнца по имени Рей, он одет в фиолетовый мешковатый пиджак с малиновым полосатым жилетом, его глаза закрывают очки с круглыми, оранжевыми линзами. В руке Рей держит открытую бутылку ливера.
ent-PosterSTmake91free = «Свободу 91-ому сектору!»
    .desc = Очень старый, покрытый пылью плакат неизвестного происхождения, призывающий вступить в ополчение и освободить 91-ый сектор...? Что за 91-ый сектор?